...
$status = "Updated Successfully. </br></br><a href='../promote'>Click Here to Continue </a>";
...
<p><input type="radio" name="roleid" value="0">Dismote
       <input type="radio" name="roleid" value="<?php echo $row['roleID'];?>">RoleID: <?php echo $row['roleID'];?></p>
<table>
